There's a gap in my documentation between the .csv files that the R scrapers spit out, and the .csv files that are fed into the Javascript code.
The R scraper returns a .csv file like mlb_example.csv, included in this folder.
I did the next three steps in Excel, but they could easily be added to the R scraper code itself:
